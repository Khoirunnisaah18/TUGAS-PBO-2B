...
public class Main{
    ...
    Main() {
        bookList[bookCount++] = new Book("1", "KANCIL", "TIMUN", 10);
        bookList[bookCount++] = new Book("2", "RUSA", "WORTEL", 15);
        bookList[bookCount++] = new Book("3", "KELINCI", "SAYUR", 20);
    }
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    return;
                default:
                    System.out.println("tertinggal oleh kancil");
            }
        }
    }
